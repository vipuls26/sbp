    ...
    <div class="min-h-screen bg-black text-white py-16 px-4">
        <div class="mx-auto max-w-2xl">
            ...
            <div class="mb-8">
                ...
                <h1 class="mt-4 text-3xl font-bold text-white">New Project</h1>
            </div>
            ...
            <form action="{{ route('projects.store') }}" method="POST"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Describe your project"
                        class="mt-2 w-full rounded-xl border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder:text-slate-500 focus:border-indigo-500 focus:outline-none">{{ old('description') }}</textarea>
